...
def check_dataset(data: Path) -> dict:
    ...
    assert 'num_class' in data, "Dataset 'num_class' key missing."
...
def coco80_to_coco91_class():  # converts 80-index (val2014) to 91-index (paper)
    ...
    # a = np.loadtxt('config/coco.names', dtype='str', delimiter='\n')
    # b = np.loadtxt('config/coco_paper.names', dtype='str', delimiter='\n')
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    time_limit = 100  # seconds to quit after
